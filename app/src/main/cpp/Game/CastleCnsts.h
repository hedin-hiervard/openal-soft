#ifndef PHEROES_GAME_CASTLECNSTS_H_
#define PHEROES_GAME_CASTLECNSTS_H_
...
//////////////////////////////////////////////////////////////////////////
class iLodgeCtlCnst : public iCtlCnst
{
public:
    IMPL_TYPEAWARE( iLodgeCtlCnst );
    iLodgeCtlCnst(iCastle* _pCastle, CTL_CONSTR _cnst);
    void OnBuild();
};
//////////////////////////////////////////////////////////////////////////
class iMerchantCtlCnst : public iCtlCnst
{
public:
    IMPL_TYPEAWARE( iMerchantCtlCnst );
    iMerchantCtlCnst(iCastle* _pCastle, CTL_CONSTR _cnst);
    void OnBuild();
};
//////////////////////////////////////////////////////////////////////////
class iScoutTowerCtlCnst : public iCtlCnst
{
public:
    IMPL_TYPEAWARE( iScoutTowerCtlCnst );
    iScoutTowerCtlCnst(iCastle* _pCastle, CTL_CONSTR _cnst);
    void OnBuild();
};
...
public:
	...
	void OnVisitorLeave(iHero* pHero);
	void OnOwnerChanged(PLAYER_ID newOwner, PLAYER_ID oldOwner);
	void Serialize(iDynamicBuffer& buff) const;
	void Unserialize(iDynamicBuffer& buff);

	void DependsList(const iCtlCnst* pCnst, iSimpleArray<uint16>& depList) const;
	void DescendantsList(const iCtlCnst* pCnst, iSimpleArray<uint16>& descList, uint32 lvl, uint32 curlvl = 0) const;
...
#endif //PHEROES_GAME_CASTLECNSTS_H_
