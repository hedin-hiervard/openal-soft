#ifndef PHEROES_GAME_ITEMMGR_H_
#define PHEROES_GAME_ITEMMGR_H_
...
public:
    ...
    // Overrides
    virtual const iCreatBonus* CreatureBonus() const = 0;
...
{
public:
    iArtT_FurtSkill(TextResId nameKey, TextResId descKey, ART_LEVEL_TYPE level, ART_ASSIGN_TYPE assignType, uint16 reqLevel, SECONDARY_SKILLS reqSecSkill, SpriteId sid, const iFurtSkills& furtSkills, const iCreatBonus& cb);

    void Attach(iHero* pOwner) const;
    void Dettach(iHero* pOwner) const;
    const iCreatBonus* CreatureBonus() const { return &m_creatBonus; };
...
public:
    ...
    const iCreatBonus* CreatureBonus() const { return NULL; };
};

class iArtT_IceAmulet : public iArtT
{
public:
    iArtT_IceAmulet(TextResId nameKey, TextResId descKey, ART_LEVEL_TYPE level, ART_ASSIGN_TYPE assignType, uint16 reqLevel, SECONDARY_SKILLS reqSecSkill, SpriteId sid);
    const iCreatBonus* CreatureBonus() const { return NULL; };
};

class iArtT_Arrow : public iArtT
{
public:
    iArtT_Arrow(TextResId nameKey, TextResId descKey, ART_LEVEL_TYPE level, ART_ASSIGN_TYPE assignType, uint16 reqLevel, SECONDARY_SKILLS reqSecSkill, SpriteId sid);
    const iCreatBonus* CreatureBonus() const { return NULL; };
};

class iArtT_FastCrossbow : public iArtT
{
public:
    iArtT_FastCrossbow(TextResId nameKey, TextResId descKey, ART_LEVEL_TYPE level, ART_ASSIGN_TYPE assignType, uint16 reqLevel, SECONDARY_SKILLS reqSecSkill, SpriteId sid);
    const iCreatBonus* CreatureBonus() const { return NULL; };
};

//
class iArtT_MagicSphere : public iArtT
{
public:
    iArtT_MagicSphere(TextResId nameKey, TextResId descKey, ART_LEVEL_TYPE level, ART_ASSIGN_TYPE assignType, uint16 reqLevel, SECONDARY_SKILLS reqSecSkill, SpriteId sid, uint32 type);
...
//
class iVisCnstT_WarAcademy: public iVisCnstT
{
public:
    IMPL_TYPEAWARE( iVisCnstT_WarAcademy );
    iVisCnstT_WarAcademy(TextResId nameKey, uint16 protoId, TextResId msgKey, TextResId vmsgKey) 
    : iVisCnstT(nameKey, protoId, msgKey, vmsgKey, VCNST_WARACADEMY, false) {}
    iVisCnst* CreateObject(const iPoint& pos);
};
//
class iVisCnstT_Harbor : public iVisCnstT
{
public:
    IMPL_TYPEAWARE( iVisCnstT_Harbor );
    iVisCnstT_Harbor(TextResId nameKey, uint16 protoId, TextResId msgKey, TextResId vmsgKey) 
    : iVisCnstT(nameKey, protoId, msgKey, vmsgKey, VCNST_HARBOR, false) {}
    iVisCnst* CreateObject(const iPoint& pos);
};
//
...
class iVisCnstT_NewTeleport : public iVisCnstT
{
public:
    IMPL_TYPEAWARE( iVisCnstT_NewTeleport );
    iVisCnstT_NewTeleport(TextResId nameKey, uint16 protoId, TextResId msgKey, TextResId vmsgKey) 
    : iVisCnstT(nameKey, protoId, msgKey, vmsgKey, VCNST_NEWTELEPORT, false) {}
    iVisCnst* CreateObject(const iPoint& pos);
};
//
...
{
public:
    iHeroT(uint16 protoId, TextResId nameKey, HERO_TYPE htype, SpriteId icn32, SpriteId icn48, SpriteId icn46) 
    : m_protoId(protoId), m_NameKey(nameKey), m_hType(htype), m_icn32(icn32), m_icn48(icn48), m_icn46(icn46) { }
