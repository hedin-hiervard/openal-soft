#ifndef PHEROES_GAME_OBJECTS_H_
#define PHEROES_GAME_OBJECTS_H_
...
struct iEnchItem {
	...
	iEnchItem(intptr_t _provider, FURTHER_SKILLS _type, ENCH_DURATION _dur, sint32 _mod)
...
//////////////////////////////////////////////////////////////////////////
class iMapItem : public iIListNode, public iBaseMapObject, public iArmyOwner
{
public:
...
//
class iMapItem_NeutralShip : public iMapItem
{
public:
    iMapItem_NeutralShip(const iPoint& pos);
    bool Activate(iHero* pHero, bool bActive, bool bShowMessage);
    void Serialize(iDynamicBuffer& buff);
    // CtllTODO: change text here later
    TextResId NameKey() { return TRID_OBJ_SHIP; }

    IMPL_TYPEAWARE( iMapItem_NeutralShip );
};
...
public:
	...
	inline void SetCount(sint32 count) { m_count = count; }
...
//
class iMapEvent : public iIListNode, public iBaseMapObject, public iArmyOwner
{
public:
	iMapEvent(const iPoint& pos);
	bool Activate(iHero* pHero, bool bActive, bool bShowMessage, bool& stopMoving);
	...
	inline const iStringT& RFailMessage() const { return m_rfailMessage; }
...
//
class iMapMarker : public iIListNode, public iBaseMapObject
{
public:
	iMapMarker(const iPoint& pos);
	IMPL_TYPEAWARE( iMapMarker );		
	inline uint8& InIndex() { return m_inIdx; }
private:
	uint8 m_inIdx;
};
...
public:
	iMapGuard(const iPoint& pos, CREATURE_TYPE ct, sint32 cnt, sint32 joinVal, GUARD_DISPOS disp = GDISP_AGGRESSIVE, bool bNotGrow = false, bool bDisabled = false);
	...
	inline bool Disabled() { return m_bDisabled; }
