#ifndef PHEROES_GAME_MAGIC_H_
#define PHEROES_GAME_MAGIC_H_
...
public:
	...
	inline SpriteId Icon() const { return PDGG(SPELL_ICONS)+m_spellId;}
...
public:
	...
	virtual bool CanBeCastOn(iBattleGroup* pTarget, MAGIC_SCHOOL_LEVEL msl, bool bFriendly) const;
...
public:
    ...
    sint32 SpellBookDamage(iHero* pCaster) const;
