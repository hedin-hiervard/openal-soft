...
const sint32 ULTART_STDMODIF[HERO_TYPE_COUNT][7][2] = {
	{
        ...
        // Variags
        {FSK_MIN_GOLD, 5000}, {FSK_ATTACK, 4}, {FSK_DEFENCE, 4}, {FSK_POWER, 4}, {FSK_KNOWLEDGE, 4}, {FSK_SEAFARING, 20}, {FSK_SPEED, 2}
    }

};
//
const SPEC_HERO_FLAGS ULTART_SPECFLAGS[HERO_TYPE_COUNT] = {
	SHF_NORANGEPENALTY,		// Knight
...
const uint8 HERO_SEC_SKILL[HERO_TYPE_COUNT][SECSK_COUNT] = {
	{ 
        ...
        2,0,2,3,		// Estates, Leadership, Luck, Diplomacy
        3,3,5,0,		// Air, Earth, Fire, Water
        4,0,4,3,2,5,4,	// Wisdom, Necromancy, Mysticism, Intelligence, Resistance, Sorcery, Learning
        4,2,3,			// Scouting, Logistics, Pathfinding, 
        1,1,0,0			// Archery, Ballistics, Offence, Armorer
   }
};
...
const iPoint SHIP1_FLAG1_ANCHOR[8] = 
{
    iPoint(7 , -47),
    iPoint(-2, -48),
    iPoint(-1, -44),
...
const iPoint SHIP1_FLAG2_ANCHOR[8] = 
{
    iPoint(7 , -47),
    iPoint(13, -50),
    iPoint(17, -44),
...
const iPoint SHIP2_FLAG1_ANCHOR[8] = 
{
    iPoint(7 , -36),
    iPoint(13, -40),
    iPoint(6 , -43),
...
const iPoint SHIP2_FLAG2_ANCHOR[8] = 
{
    iPoint(7 , -36),
    iPoint(1 , -40),
    iPoint(22, -40),
...
iMineralSet operator-(const iMineralSet& ms)  { 
	iMineralSet res; for (uint32 xx=0; xx<MINERAL_COUNT; ++xx) res.quant[xx] = -ms.quant[xx]; return res; 
}
