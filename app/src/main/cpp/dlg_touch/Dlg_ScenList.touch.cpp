...
public:
	...
	inline uint32 LBItemHeight() const { return 30; }
...
void iScenListDlg::OnCreateDlg()
{
	...
	// Listbox header
	AddChild(new iDlgIconButton(m_pMgr, this, iRect(clRect.x,clRect.y + yoffs, btnw,DEF_BTN_HEIGHT), PDGG(BTN_MAPSIZE), 501));
	AddChild(new iDlgIconButton(m_pMgr, this, iRect(clRect.x+btnw+1,clRect.y + yoffs, btnw,DEF_BTN_HEIGHT), PDGG(BTN_PLAYERS_COUNT), 502));
