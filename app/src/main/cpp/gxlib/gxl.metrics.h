#ifndef GXLIB_GXL_METRICS_H_
#define GXLIB_GXL_METRICS_H_
...
public:
	...
	{
		SIZE siz={static_cast<LONG>(w),static_cast<LONG>(h)};
		return siz;
	}
...
public:
	...
	inline iPoint operator/ (double f) const 
	{
		 return iPoint((sint32)(x / f), (sint32)(y / f));
	}
	...
	inline uint32 GetLength() const {
		return (uint32)sqrt(float(x * x + y * y));
	}
