#ifndef GXLIB_GXL_CTR_FARRAY_H_
#define GXLIB_GXL_CTR_FARRAY_H_
...
{
	if ( index >= QUAL::GetSize() ) return End();
...
//{
//	if ( index >= QUAL::Count() )	return End();
//
//	return First() + index;
//}
