#ifndef GXLIB_IPHONE_SPECIFIC_CORESURFACE_CORESURFACE_H_
#define GXLIB_IPHONE_SPECIFIC_CORESURFACE_CORESURFACE_H_
...
#endif //GXLIB_IPHONE_SPECIFIC_CORESURFACE_CORESURFACE_H_
