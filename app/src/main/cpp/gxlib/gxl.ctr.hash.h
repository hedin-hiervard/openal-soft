#ifndef GXLIB_GXL_CTR_HASH_H_
#define GXLIB_GXL_CTR_HASH_H_
/** @file
...
public:
	...
	public:
		...
		{
			return _Iterator::node == other.node;
		}
	...
	public:
		...
		{
			ConstIterator it (*this);
			return _Iterator::it.operator-=(n);
		}
